...
{
    /** @var string */
    public $pathPattern = '/person/v1/clusters/[ClusterId]/scale_metadata';
}
...
{
    /** @var string */
    public $pathPattern = '/person/v1/metadata/versions';
...
{
    /** @var string */
    public $pathPattern = '/person/v1/ess/precheck';
...
{
    /** @var string */
    public $pathPattern = '/person/v1/vpc/[VpcId]/cidrs';
}
